...
public class RecoveryTestResult extends TestResult {

    private LinkedList<RecoveryRecord> results = new LinkedList<>();

    public RecoveryTestResult() {
        super("RecoveryTestResult");
    }
    ...
    public LinkedList<RecoveryRecord> getResults() {
        return results;
    }

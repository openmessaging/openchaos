...
public class RocketMQChaosNode implements QueueNode {
    ...
    public void start() {
        try {
            ...
            SshUtil.execCommandInDir(node, installDir, String.format("nohup sh rocketmq-5.0.0-BETA-SNAPSHOT/bin/mqbroker -c /home/rocketmq/conf/broker/broker1.conf > broker.log 2>&1 &"
